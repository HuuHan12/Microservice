package com.ltfullstack.bookservice.command.agregate;
...
public class BookAggregate {
    @AggregateIdentifier // sẽ liên kết đến targetIdentifier giúp cho khi mà phát ra 1 command sẽ liên kết đến BookAggregate
    private String id;
    private String name;
    ...
    @CommandHandler
    public void handle(UpdateStatusBookCommnand command){
